...
\def\documentparskip {10}           % Tamaño adicional entre párrafos (+/-) [pt]
...
\def\disablehfrightmark {true}    % Desactiva el rightmark del header-footer
\def\hfstyle {style3}              % Estilo header-footer (16 estilos)
...
\def\portraitstyle {style8}        % Estilo portada (21 estilos)
