...
\subsubsubsection{Resumen de la Arquitectura}
...
\insertimage[\label{arquitectura_software}]{secciones/section_4/images/arquitectura_software}{width=13cm}{Resumen de Arquitectura en el Cloud}
...
\subsubsubsectionanumnoi{Autenticación del usuario}
...
\subsubsubsectionanumnoi{Base de datos NoSQL}
...
\subsubsubsectionanumnoi{Indexación H3 - Uber System Approach}
...
\subsubsubsection{Flutter como framework principal}
...
\subsubsubsection{Búsqueda de estacionamientos disponibles}
