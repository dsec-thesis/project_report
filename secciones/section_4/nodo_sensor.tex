...
\subsubsection{Determinación de sensores}
...
A continuación dejamos una tabla comparativa entre ambos sensores y su aplicación:
\clearpage
...
Este proceso se aplicó a los datos obtenidos en la seccion previa obteniendo como
...
\subsubsection{Configuración del nodo sensor}
...
\subsubsubsection{Funcionamiento del nodo (considerando los modos de energía)}
