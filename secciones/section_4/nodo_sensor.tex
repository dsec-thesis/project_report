...
En esta sección se describe el firmware implementado en el nodo sensor del proyecto, como así tambien la detección de anomalías en los datos del magnetómetro, utilizando la técnica de la \quotes{media móvil} para identificar valores atípicos en comparación con el histórico de datos.
